...
<h2 align="center">Customer Orderlist</h2>
...
//
mysql_query("UPDATE `cart` SET `user_id`='$_SESSION[user_id]' WHERE `ip_add`='$ip_add'");
//
...
<a href="orderlist.php?id=<?php echo $ProData['id'];?>"><i class="fa fa-times" style=" color:#0088cc; font-size:20px;"></i></a>
</td>
<td style=" padding:10px;">
<?php echo $cartData['status'];?>
</td>
<td style="padding:10px;">
...
<a href="orderlist.php?reduceid=<?php echo $cartData['id'];?>" 
...
<a href="orderlist.php?incrementid=<?php echo $cartData['id'];?>" class="btn btn-primary"/>+</a>
</div>
</td>
<td>
<?php 
...
?>
	<tr>
	<td colspan="5" class="bg-success" align="right"><b>SUB TOTAL</b></td>
